...
.setPrefix('View <a href="http://github.com/katiebenti/leaflet-map-polygon-tabs">data and code on GitHub</a>, created with <a href="http://leafletjs.com" title="A JS library for interactive maps">Leaflet</a>; design by <a href="http://ctmirror.org">CT Mirror</a>');
...
$.getJSON("ct-towns-time-trends.geojson", function (data) {
...
info.update = function (props) {
  ...
  this._div.innerHTML = (props ?
    '<div class="areaName">' + props.name + '</div>' : '<div class="areaName faded"><small>Hover over areas<br>Click tabs or arrow keys</small></div>') + '<div class="areaLabel"><div class="areaValue">Victimizations per 1,000</div>' +(props ? '' + (checkNull(props["index" + year])) : '--') + '</div>';
};
info.addTo(map);
